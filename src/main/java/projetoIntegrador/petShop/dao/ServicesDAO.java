...
import projetoIntegrador.petShop.model.ToDo;
import projetoIntegrador.petShop.model.Services;
...
public class ServicesDAO {
    ...
    public void deleteServices(Services obj) {
        try {
            ...
            deleteServiceToDosByServiceId(obj.getId());
    ...
    public List<ToDo> listToDos(LocalDate date_start, LocalDate date_end) {
        try {
            List<ToDo> listToDos = new ArrayList<>();
    ...
    public List<ToDo> listToDosForToday() {
        List<ToDo> listToDosForToday = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                listToDosForToday.add(obj);
            }

            return listToDosForToday;
        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null, "Erro: " + erro);
            return null;
        }
    ...
    public boolean checkToDoConflict(ToDo obj) {
        try {
    ...
    public void deleteToDoByPetId(int petId) {
        try {
    ...
    public void deleteServiceToDosByServiceId(int serviceId) {
        try {
            String sqlToDos = "DELETE FROM tb_service_schedules WHERE service_id = ?";
            PreparedStatement stmtToDos = con.prepareStatement(sqlToDos);
            stmtToDos.setInt(1, serviceId);
            stmtToDos.execute();
            stmtToDos.close();
        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null, "Erro: " + erro);
