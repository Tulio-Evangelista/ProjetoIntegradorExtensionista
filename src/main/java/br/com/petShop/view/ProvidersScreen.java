...
public class ProvidersScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Love Pet | Cadastro de Funcionários");
        setResizable(false);
    ...
    private void searchFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyPressed
        ...
        ProvidersDAO dao = new ProvidersDAO();
        List<Providers> listProviders = dao.searchProviders(name);
        DefaultTableModel data = (DefaultTableModel) table.getModel();
        data.setNumRows(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProvidersScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProvidersScreen().setVisible(true);
            }
        });
    }
