...
public class ServicesToDoScreen extends javax.swing.JFrame {

    public void listTable() {
        ServicesDAO dao = new ServicesDAO();
        List<ToDo> listSchedules = dao.listToDo();
        DefaultTableModel data = (DefaultTableModel) servicesTable.getModel();
        data.setNumRows(0);

        for (ToDo s : listSchedules) {
    ...
    private void initComponents() {
        ...
        setTitle("Love Pet | Agenda de Serviços");
        setResizable(false);
    ...
    private void addBntActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBntActionPerformed
       ...
       ToDoServicesScreen scheduleservices = new ToDoServicesScreen();
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try {
            ...
            List<ToDo> list = services_dao.listToDo();
    ...
    private void servicesTodayBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_servicesTodayBtnActionPerformed
        ...
        ServicesDAO services_dao = new ServicesDAO();
        List<ToDo> listSchedulesForToday = services_dao.listToDosForToday();

        DefaultTableModel data = (DefaultTableModel) servicesTable.getModel();
        data.setNumRows(0);

        for (ToDo s : listSchedulesForToday) {
            data.addRow(new Object[]{
                    s.getId(),
                    s.getCustumers().getName(),
                    s.getPets().getPet_name(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicesToDoScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServicesToDoScreen().setVisible(true);
            }
        });
    }
